...
export default function PreviewLayout({
  ...
  return (
    <div className="flex min-h-screen bg-ink">
      ...
      {/* Sidebar — right side */}
      <aside className="sticky top-0 hidden h-screen w-60 shrink-0 flex-col overflow-y-auto border-l border-line bg-surface/60 p-5 sm:flex">
